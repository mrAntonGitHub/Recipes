...
class MealViewModel : ViewModel(){
    ...
    val cookingSteps = listOf(
        CookingStep("Возьмите 5 ломтиков хлеба и выложите их в сковороду", imageUrlSet = listOf("https://2.bp.blogspot.com/-nz6SjwwaIXA/WekiFYkd5LI/AAAAAAAADZU/eOJXR8uyt3gmBe2ILUeP4-GCqC7Mo-xPgCLcBGAs/s1600/Forerib-of-beef.jpg")),
